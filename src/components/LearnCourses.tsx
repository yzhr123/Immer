...
export default function LearnCourses({ courses, progresses, activeSubject, onSubjectChange, onDelete }: Props) {
    ...
    <div className="mt-8">
      ...
      <div className="max-w-xs mx-auto mb-6">
        <input
          ...
          placeholder="搜索课程..."
          className="w-full text-xs tracking-wider outline-none py-2 px-4 transition-all duration-200"
          style={{
            borderRadius: '12px',
      ...
      {/* No results */}
      {filtered.length === 0 && (searchQuery.trim() || activeSubject !== 'all') && (
          ...
          >
            ...
            <div className="relative p-5 sm:p-6">
              <div className="flex items-start justify-between mb-2">
                <span className="text-base tracking-wider" style={{ color: '#555' }}>{course.icon}</span>
                <span
